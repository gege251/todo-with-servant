module Style exposing (container, elementPop, elementUnpop, flex__right, footer, form, formElement, form__btn, form__txt, menu, nav, nav__container, nav__title, theme, title, toRgba, todo__chkbox, todo__li)
...
elementPop =
    batch
        ...
        , zIndex (int 500)
        , transition
            [ T.boxShadow (0.5 * 1000)
            , T.transform (0.5 * 1000)
            ]
        ]
...
elementUnpop =
    batch
        ...
        , boxShadow none
        , transition
            [ T.boxShadow (0.3 * 1000)
            , T.transform (0.3 * 1000)
            ]
        ]
