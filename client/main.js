...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.aA, request.aM, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.aM)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	elm$core$Maybe$isJust(request.aF) && (xhr.timeout = request.aF.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		aM: xhr.responseURL,
		cA: { cc: xhr.status, D: xhr.statusText },
...
var author$project$Main$AfterGetTodo = function (a) {
	return {$: 5, a: a};
};
var krisajenkins$remotedata$RemoteData$NotAsked = {$: 0};
var author$project$Main$initModel = {O: '', p: krisajenkins$remotedata$RemoteData$NotAsked};
...
var author$project$Requests$Todo = F3(
	function (id, value, done) {
		return {Y: done, o: id, bg: value};
	});
var elm$json$Json$Decode$bool = _Json_decodeBool;
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Requests$decodeTodo = A3(
	...
	A3(
		...
		A3(
			...
			elm$json$Json$Decode$succeed(author$project$Requests$Todo))));
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.I);
			if (_n0.$ === 1) {
...
var author$project$Requests$getTodo = elm$http$Http$request(
	{
		I: elm$http$Http$emptyBody,
		av: elm$http$Http$expectJson(
			elm$json$Json$Decode$list(author$project$Requests$decodeTodo)),
		ax: _List_Nil,
		aA: 'GET',
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		A2(
			...
			author$project$Main$AfterGetTodo,
			krisajenkins$remotedata$RemoteData$sendRequest(author$project$Requests$getTodo)));
};
var author$project$Main$AfterPostTodo = F2(
	function (a, b) {
		return {$: 6, a: a, b: b};
	});
var author$project$Main$NoOp = {$: 0};
var author$project$Requests$NewTodo = function (value) {
	return {bg: value};
};
var author$project$Requests$NoContent = 0;
var elm$core$String$isEmpty = function (string) {
	return string === '';
};
var elm$url$Url$percentEncode = _Url_percentEncode;
var author$project$Requests$deleteTodoByTodoId = function (capture_todoId) {
	return elm$http$Http$request(
		{
			...
			av: elm$http$Http$expectStringResponse(
				function (_n0) {
					var body = _n0.I;
					return elm$core$String$isEmpty(body) ? elm$core$Result$Ok(0) : elm$core$Result$Err('Expected the response body to be empty');
				}),
			ax: _List_Nil,
			aA: 'DELETE',
			aF: elm$core$Maybe$Nothing,
			aM: A2(
				...
				_List_fromArray(
					[
						...
						elm$core$String$fromInt(capture_todoId))
					])),
			aO: false
		});
};
...
var author$project$Requests$encodeNewTodo = function (x) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'value',
				elm$json$Json$Encode$string(x.bg))
			]));
};
...
var author$project$Requests$postTodo = function (body) {
	return elm$http$Http$request(
		{
			I: elm$http$Http$jsonBody(
				author$project$Requests$encodeNewTodo(body)),
			av: elm$http$Http$expectJson(author$project$Requests$decodeTodo),
			ax: _List_Nil,
			aA: 'POST',
			aF: elm$core$Maybe$Nothing,
			aM: A2(
...
var author$project$Requests$encodeTodo = function (x) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(x.o)),
				_Utils_Tuple2(
				'value',
				elm$json$Json$Encode$string(x.bg)),
				_Utils_Tuple2(
				'done',
				elm$json$Json$Encode$bool(x.Y))
			]));
};
var author$project$Requests$putTodoByTodoId = F2(
	function (capture_todoId, todo) {
		return elm$http$Http$request(
			{
				I: elm$http$Http$jsonBody(
					author$project$Requests$encodeTodo(todo)),
				av: elm$http$Http$expectStringResponse(
					function (_n0) {
						var body = _n0.I;
						return elm$core$String$isEmpty(body) ? elm$core$Result$Ok(0) : elm$core$Result$Err('Expected the response body to be empty');
...
var author$project$Utils$uniqueId = function (list) {
	var uniqueId_ = function (newId) {
		uniqueId_:
		while (true) {
			if (A2(
				elm$core$List$all,
				function (id) {
					return !_Utils_eq(id, newId);
				},
				list)) {
				return newId;
			} else {
				var $temp$newId = newId + 1;
				newId = $temp$newId;
				continue uniqueId_;
			}
		}
		...
		switch (msg.$) {
			...
			case 2:
				...
				var addTodo = function (todos) {
					var newtodo = {
						Y: false,
						o: author$project$Utils$uniqueId(
							A2(
								elm$core$List$map,
								function ($) {
									return $.o;
					...
					return _Utils_Tuple2(
						A2(elm$core$List$cons, newtodo, todos),
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$AfterPostTodo(newtodo.o),
							krisajenkins$remotedata$RemoteData$sendRequest(
								author$project$Requests$postTodo(
									author$project$Requests$NewTodo(newvalue)))));
				};
				var _n1 = A2(krisajenkins$remotedata$RemoteData$update, addTodo, model.p);
				var newtodos = _n1.a;
				var cmd = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 3:
				var id = msg.a;
				var delTodo = function (todos) {
					return _Utils_Tuple2(
						A2(
							elm$core$List$filter,
							function (t) {
								return !_Utils_eq(t.o, id);
							},
							todos),
						A2(
							elm$core$Platform$Cmd$map,
							...
							krisajenkins$remotedata$RemoteData$sendRequest(
								author$project$Requests$deleteTodoByTodoId(id))));
				};
				var _n2 = A2(krisajenkins$remotedata$RemoteData$update, delTodo, model.p);
				var newtodos = _n2.a;
				var cmd = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
				...
				var toggleTodo = function (todos) {
					var maybeTodo = A2(
						...
						A2(
							...
							todos));
					if (maybeTodo.$ === 1) {
						return _Utils_Tuple2(todos, elm$core$Platform$Cmd$none);
					} else {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								krisajenkins$remotedata$RemoteData$sendRequest(
									A2(author$project$Requests$putTodoByTodoId, id, todo))));
					}
				};
				var _n4 = A2(krisajenkins$remotedata$RemoteData$update, toggleTodo, model.p);
				var newtodos = _n4.a;
				var cmd = _n4.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var oldId = msg.a;
				var response = msg.b;
				var _n7 = krisajenkins$remotedata$RemoteData$toMaybe(response);
				if (_n7.$ === 1) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var newtodo = _n7.a;
					var amendId = function (todos) {
						var updateId = function (todo) {
							return _Utils_update(
								todo,
								{o: newtodo.o});
						};
						return _Utils_Tuple2(
							A3(
								elm_community$list_extra$List$Extra$updateIf,
								function (t) {
									return _Utils_eq(t.o, oldId);
								},
								updateId,
								todos),
							elm$core$Platform$Cmd$none);
					};
					var _n8 = A2(krisajenkins$remotedata$RemoteData$update, amendId, model.p);
					var newtodos = _n8.a;
					var cmd = _n8.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var rtfeldman$elm_css$Css$auto = {b5: 0, a: 0, _: 0, aU: 0, co: 0, ae: 0, C: 0, v: 0, ah: 0, s: 0, a$: 0, ao: 0, q: 0, bg: 'auto'};
...
var rtfeldman$elm_css$Css$prop1 = F2(
	function (key, arg) {
		return A2(rtfeldman$elm_css$Css$property, key, arg.bg);
	});
var rtfeldman$elm_css$Css$bottom = rtfeldman$elm_css$Css$prop1('bottom');
var rtfeldman$elm_css$Css$center = rtfeldman$elm_css$Css$prop1('center');
var rtfeldman$elm_css$Css$fixed = {au: 0, aC: 0, a$: 0, bg: 'fixed'};
...
var Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {W: charsProcessed, ac: hash, Q: seed, ak: shift};
	});
...
var Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = data.ac ? (data.Q ^ A2(
		Skinney$murmur3$Murmur3$multiplyBy,
		Skinney$murmur3$Murmur3$c2,
		A2(
			Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2(Skinney$murmur3$Murmur3$multiplyBy, Skinney$murmur3$Murmur3$c1, data.ac)))) : data.Q;
	var h0 = acc ^ data.W;
...
var Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_n0 === 24) {
			...
			return {W: data.W + 1, ac: res, Q: data.Q, ak: data.ak + 8};
		}
	});
...
var rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bt: elm$core$Maybe$Nothing, bF: _List_Nil, bM: _List_Nil, bZ: snippets};
};
...
var rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_n0) {
	var charset = _n0.bt;
	var imports = _n0.bF;
	var namespaces = _n0.bM;
	var snippets = _n0.bZ;
	var declarations = rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2(elm$core$List$concatMap, rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bt: charset, ce: declarations, bF: imports, bM: namespaces};
};
...
var rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_n0) {
	...
	return {bt: charset, ce: finalDeclarations, bF: imports, bM: namespaces};
};
...
var author$project$Style$footer = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[author$project$Style$footer]),
	_List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$text('This is a nice footer.')
		]));
var author$project$Main$InputTodoField = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$SubmitTodo = function (a) {
	return {$: 2, a: a};
};
var rtfeldman$elm_css$Css$margin = rtfeldman$elm_css$Css$prop1('margin');
var author$project$Style$form = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
	...
	function (key, argA, argB, argC, argD) {
		return A2(
			...
			A2(
				...
				' ',
				_List_fromArray(
					[argA.bg, argB.bg, argC.bg, argD.bg])));
	});
...
var rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		ap: '',
		aL: 0,
		bg: elm$core$String$fromInt(val)
	};
};
...
var rtfeldman$elm_css$Css$valuesOrNone = function (list) {
	return elm$core$List$isEmpty(list) ? {bg: 'none'} : {
		bg: A2(
			elm$core$String$join,
			' ',
			A2(
...
var rtfeldman$elm_css$Css$Transitions$durationTransition = F2(
	function (animation, duration) {
		return {aP: animation, aR: elm$core$Maybe$Nothing, aS: duration, a0: elm$core$Maybe$Nothing};
	});
...
var author$project$Style$elementPop = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$transform(
			rtfeldman$elm_css$Css$scale(1.3)),
			A4(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$Transitions$boxShadow(0.5 * 1000),
					rtfeldman$elm_css$Css$Transitions$transform(0.5 * 1000)
				]))
		]));
var rtfeldman$elm_css$Css$boxShadow = rtfeldman$elm_css$Css$prop1('box-shadow');
var rtfeldman$elm_css$Css$none = {U: 0, bo: 0, m: 0, a: 0, f: 0, cl: 0, bG: 0, a7: 0, ag: 0, L: 0, v: 0, c: 0, b: 0, a9: 0, aX: 0, cu: 0, s: 0, aY: 0, cy: 0, am: 0, S: 0, q: 0, e: 0, cE: 0, bg: 'none'};
var author$project$Style$elementUnpop = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$transform(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$Transitions$boxShadow(0.3 * 1000),
					rtfeldman$elm_css$Css$Transitions$transform(0.3 * 1000)
				]))
		]));
...
var rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		cj: 0,
		cv: 0,
		bg: rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var author$project$Style$theme = {
	bq: rtfeldman$elm_css$Css$hex('eee'),
	by: rtfeldman$elm_css$Css$hex('eee'),
	a6: rtfeldman$elm_css$Css$hex('808080'),
	bz: rtfeldman$elm_css$Css$hex('eee'),
	bA: rtfeldman$elm_css$Css$hex('d3d3d3'),
	bB: rtfeldman$elm_css$Css$hex('f00'),
	bC: rtfeldman$elm_css$Css$hex('fff'),
	bJ: rtfeldman$elm_css$Css$hex('3498db'),
	bK: rtfeldman$elm_css$Css$hex('fff')
};
var rtfeldman$elm_css$Css$backgroundColor = function (c) {
	return A2(rtfeldman$elm_css$Css$property, 'background-color', c.bg);
};
var rtfeldman$elm_css$Css$borderStyle = rtfeldman$elm_css$Css$prop1('border-style');
var rtfeldman$elm_css$Css$height = rtfeldman$elm_css$Css$prop1('height');
var author$project$Style$formElement = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$height(
			rtfeldman$elm_css$Css$rem(2)),
			rtfeldman$elm_css$Css$backgroundColor(author$project$Style$theme.by),
			rtfeldman$elm_css$Css$borderStyle(rtfeldman$elm_css$Css$none)
		]));
var rtfeldman$elm_css$Css$color = function (c) {
	return A2(rtfeldman$elm_css$Css$property, 'color', c.bg);
};
...
var author$project$Style$form__btn = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			author$project$Style$formElement,
			rtfeldman$elm_css$Css$color(author$project$Style$theme.a6),
			rtfeldman$elm_css$Css$padding(
			rtfeldman$elm_css$Css$px(5)),
			author$project$Style$elementUnpop,
			rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$backgroundColor(author$project$Style$theme.bB),
					rtfeldman$elm_css$Css$color(author$project$Style$theme.bC),
					author$project$Style$elementPop
				])),
			rtfeldman$elm_css$Css$disabled(
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$backgroundColor(author$project$Style$theme.bz),
					rtfeldman$elm_css$Css$color(author$project$Style$theme.bA),
					author$project$Style$elementUnpop
				]))
		]));
var rtfeldman$elm_css$Css$padding2 = rtfeldman$elm_css$Css$prop2('padding');
var author$project$Style$form__txt = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			author$project$Style$formElement,
			A2(
...
var rtfeldman$elm_css$Css$bold = {B: 0, bg: 'bold'};
var rtfeldman$elm_css$Css$fontWeight = function (_n0) {
	var value = _n0.bg;
	return A2(rtfeldman$elm_css$Css$property, 'font-weight', value);
};
var author$project$Style$nav = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$width(
			rtfeldman$elm_css$Css$pct(100)),
			rtfeldman$elm_css$Css$fontWeight(rtfeldman$elm_css$Css$bold),
			rtfeldman$elm_css$Css$backgroundColor(author$project$Style$theme.bJ),
			rtfeldman$elm_css$Css$padding(
			rtfeldman$elm_css$Css$rem(0.5))
		]));
...
var author$project$Style$nav__container = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$Style$nav__title = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$color(author$project$Style$theme.bK),
...
var author$project$Main$viewHeader = function (model) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[author$project$Style$nav]),
		_List_fromArray(
			[
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[author$project$Style$nav__container]),
				_List_fromArray(
					[
						A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[author$project$Style$nav__title]),
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Todo App')
							])),
						A2(
						rtfeldman$elm_css$Html$Styled$form,
						_List_fromArray(
							[
								author$project$Style$form,
								rtfeldman$elm_css$Html$Styled$Events$onSubmit(
								author$project$Main$SubmitTodo(model.O))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										author$project$Style$form__txt,
										rtfeldman$elm_css$Html$Styled$Attributes$type_('text'),
										rtfeldman$elm_css$Html$Styled$Attributes$placeholder('todo'),
										rtfeldman$elm_css$Html$Styled$Attributes$value(model.O),
										rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$InputTodoField)
									]),
								_List_Nil),
								A2(
								...
								_List_fromArray(
									[
										author$project$Style$form__btn,
										rtfeldman$elm_css$Html$Styled$Attributes$disabled(model.O === '')
									]),
								_List_fromArray(
									[
...
var author$project$Main$DelTodo = function (a) {
	return {$: 3, a: a};
};
...
var author$project$Style$flex__right = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$marginLeft(rtfeldman$elm_css$Css$auto)
		]));
var author$project$Style$todo__chkbox = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$margin(
			rtfeldman$elm_css$Css$rem(0.5))
...
var rtfeldman$elm_css$Css$solid = {m: 0, R: 0, bg: 'solid'};
var author$project$Style$todo__li = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
...
var author$project$Main$viewListElem = function (todo) {
	return A2(
		rtfeldman$elm_css$Html$Styled$li,
		_List_fromArray(
			[author$project$Style$todo__li]),
		_List_fromArray(
			[
				A2(
				rtfeldman$elm_css$Html$Styled$input,
				_List_fromArray(
					[
						author$project$Style$todo__chkbox,
						rtfeldman$elm_css$Html$Styled$Attributes$type_('checkbox'),
						rtfeldman$elm_css$Html$Styled$Attributes$checked(todo.Y),
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$Main$ToggleTodo(todo.o))
					]),
				_List_Nil),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(todo.bg)
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$button,
				_List_fromArray(
					[
						author$project$Style$form__btn,
						author$project$Style$flex__right,
						rtfeldman$elm_css$Html$Styled$Events$onClick(
						author$project$Main$DelTodo(todo.o)),
						rtfeldman$elm_css$Html$Styled$Attributes$disabled(!todo.Y)
					]),
				_List_fromArray(
					[
...
var author$project$Main$viewTodoList = function (todos) {
	switch (todos.$) {
		...
		case 3:
			var list = todos.a;
			var _n1 = elm$core$List$length(list);
			if (!_n1) {
				return rtfeldman$elm_css$Html$Styled$text('No items.');
			} else {
				var otherwise = _n1;
				return A2(
					rtfeldman$elm_css$Html$Styled$ul,
					_List_Nil,
					A2(elm$core$List$map, author$project$Main$viewListElem, list));
			}
		default:
			var error = todos.a;
			return rtfeldman$elm_css$Html$Styled$text('Could not fetch todos.');
	}
};
var author$project$Style$container = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$maxWidth(
			rtfeldman$elm_css$Css$px(800)),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Todo list')
							])),
						author$project$Main$viewTodoList(model.p)
					])),
